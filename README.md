...
## Warum passt das Projekt zum StochaHackathon?

Das Projekt erfüllt beide möglichen Richtungen der Aufgabe:

1. Es visualisiert ein Konzept aus der Wahrscheinlichkeitsrechnung.
2. Es implementiert eine Simulation, die auf Zufallsexperimenten basiert.

Außerdem ist es leicht installierbar, Open Source und verwendet nur kostenlose Bibliotheken.
